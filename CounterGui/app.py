...
class Main(tkinter.Tk):
    def __init__(self):
        ...
        self.homeButton = tkinter.Button(self.side_nav, width=7, text="Home", image=self.homeIcon, compound=tkinter.TOP, **self.buttonConfig)
        ...
        self.settingsButton = tkinter.Button(self.side_nav, width=7, text="Settings", image=self.settingsIcon, compound=tkinter.TOP, **self.buttonConfig)
        ...
        self.quitButton = tkinter.Button(self.side_nav, text="Logout", width=5,image=self.logoutIcon, compound=tkinter.TOP, **self.buttonConfig)
        ...
        self.createOrders = tkinter.Button(self.customermanager, text="Order Queue",width=17, bg='#f5f4f2', **self.fontConfig)
        ...
        self.style.configure("Treeview.Heading", font=('DejaVu Sans', 11, "bold"))
        ...
        self.taxLabel = tkinter.Label(self.totalsFrame,text="Tax",font=("Arial", "14", "bold"))
